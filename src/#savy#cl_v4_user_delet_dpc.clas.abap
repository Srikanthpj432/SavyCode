class /SAVY/CL_V4_USER_DELET_DPC definition
  public
...
CLASS /SAVY/CL_V4_USER_DELET_DPC IMPLEMENTATION.


  method /IWBEP/IF_V4_DP_BASIC~CREATE_ENTITY.
*&-----------------------------------------------------------------------------------------------*
*&* This class has been generated  on 23.03.2026 17:27:38 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside DPC subclass - /SAVY/CL_V4_USER_DELET_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC subclass - /SAVY/CL_V4_USER_DELET_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*  DATA ls_statusresult  TYPE /savy/cl_v4_user_delet_mpc=>ts_statusresult.
...
*Used for setting business data
*  DATA lt_statusresult TYPE /savy/cl_v4_user_delet_mpc=>tt_statusresult.
