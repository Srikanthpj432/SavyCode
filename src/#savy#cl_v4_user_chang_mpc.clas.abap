class /SAVY/CL_V4_USER_CHANG_MPC definition
  public
...
public section.
  ...
  types:
     TS_ADDRESSX type BAPIADDR3X .
  types:
     TS_COMPANY1 type BAPIUSCOMP .
  types:
     TS_COMPANYX type BAPIUSCOMX .
  types:
     TS_DEFAULTS type BAPIDEFAUL .
  types:
     TS_DEFAULTSX type BAPIDEFAX .
  types:
     TS_GROUPSX type BAPIGROUPX .
  types:
     TS_LOGONDATA type BAPILOGOND .
  types:
     TS_LOGONDATAX type BAPILOGONX .
  types:
     TS_PARAMETERX type BAPIPARAMX .
  types:
     TS_REFUSER type BAPIREFUS .
  types:
     TS_REFUSERX type BAPIREFUSX .
  types:
  ...
  types:
     begin of TS_USERCHANGE,
         LOGONDATAX type TS_LOGONDATAX,
         PARAMETERX type TS_PARAMETERX,
         REF_USER type TS_REFUSER,
         REF_USERX type TS_REFUSERX,
         GROUPSX type TS_GROUPSX,
         ADDRESS type TS_ADDRESS,
         ADDRESSX type TS_ADDRESSX,
         DEFAULTSX type TS_DEFAULTSX,
...
CLASS /SAVY/CL_V4_USER_CHANG_MPC IMPLEMENTATION.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA ls_ADDRESSX TYPE bapiaddr3x.
 DATA ls_COMPANY1 TYPE bapiuscomp.
 DATA ls_COMPANYX TYPE bapiuscomx.
 DATA ls_DEFAULTS TYPE bapidefaul.
 DATA ls_DEFAULTSX TYPE bapidefax.
 DATA ls_GROUPSX TYPE bapigroupx.
 ...
 DATA ls_REFUSERX TYPE bapirefusx.
***********************************************************************************************************************************
...
***********************************************************************************************************************************
 lo_complex_type = io_model->create_complex_type_by_struct( iv_complex_type_name = 'ADDRESSX' is_structure = ls_ADDRESSX
                                                            iv_add_conv_to_prim_props = abap_true ). "#EC NOTEXT

 lo_complex_type->set_edm_name( 'Addressx' ).               "#EC NOTEXT
...
***********************************************************************************************************************************
 lo_complex_type = io_model->create_complex_type_by_struct( iv_complex_type_name = 'COMPANYX' is_structure = ls_COMPANYX
                                                            iv_add_conv_to_prim_props = abap_true ). "#EC NOTEXT

 lo_complex_type->set_edm_name( 'Companyx' ).               "#EC NOTEXT
...
***********************************************************************************************************************************
 ...
 lo_prim_prop->set_edm_name( 'Company' ).                   "#EC NOTEXT
 lo_prim_prop->set_edm_type( iv_edm_type = 'String' ).      "#EC NOTEXT
 lo_prim_prop->set_max_length( iv_max_length = '1' ).       "#EC NOTEXT
***********************************************************************************************************************************
...
***********************************************************************************************************************************
 lo_complex_type = io_model->create_complex_type_by_struct( iv_complex_type_name = 'DEFAULTSX' is_structure = ls_DEFAULTSX
                                                            iv_add_conv_to_prim_props = abap_true ). "#EC NOTEXT

 lo_complex_type->set_edm_name( 'Defaultsx' ).              "#EC NOTEXT
...
***********************************************************************************************************************************
 ...
 lo_prim_prop = lo_complex_type->create_prim_property( iv_property_name = 'CATT' ). "#EC NOTEXT
 lo_prim_prop->set_add_annotations( abap_true ).

 lo_prim_prop->set_edm_name( 'Catt' ).                      "#EC NOTEXT
 lo_prim_prop->set_edm_type( iv_edm_type = 'String' ).      "#EC NOTEXT
 lo_prim_prop->set_max_length( iv_max_length = '1' ).       "#EC NOTEXT
...
***********************************************************************************************************************************
 lo_complex_type = io_model->create_complex_type_by_struct( iv_complex_type_name = 'GROUPSX' is_structure = ls_GROUPSX
                                                            iv_add_conv_to_prim_props = abap_true ). "#EC NOTEXT

 lo_complex_type->set_edm_name( 'Groupsx' ).                "#EC NOTEXT

***********************************************************************************************************************************
*   Properties
***********************************************************************************************************************************
 lo_prim_prop = lo_complex_type->create_prim_property( iv_property_name = 'USERGROUP' ). "#EC NOTEXT
 lo_prim_prop->set_add_annotations( abap_true ).

 lo_prim_prop->set_edm_name( 'Usergroup' ).                 "#EC NOTEXT
 lo_prim_prop->set_edm_type( iv_edm_type = 'String' ).      "#EC NOTEXT
 lo_prim_prop->set_max_length( iv_max_length = '1' ).       "#EC NOTEXT
***********************************************************************************************************************************
...
***********************************************************************************************************************************
 lo_complex_type = io_model->create_complex_type_by_struct( iv_complex_type_name = 'LOGONDATAX' is_structure = ls_LOGONDATAX
                                                            iv_add_conv_to_prim_props = abap_true ). "#EC NOTEXT

 lo_complex_type->set_edm_name( 'Logondatax' ).             "#EC NOTEXT
...
***********************************************************************************************************************************
 lo_complex_type = io_model->create_complex_type_by_struct( iv_complex_type_name = 'PARAMETERX' is_structure = ls_PARAMETERX
                                                            iv_add_conv_to_prim_props = abap_true ). "#EC NOTEXT

 lo_complex_type->set_edm_name( 'Parameterx' ).             "#EC NOTEXT

***********************************************************************************************************************************
*   Properties
***********************************************************************************************************************************
 lo_prim_prop = lo_complex_type->create_prim_property( iv_property_name = 'PARID' ). "#EC NOTEXT
 lo_prim_prop->set_add_annotations( abap_true ).

 lo_prim_prop->set_edm_name( 'Parid' ).                     "#EC NOTEXT
 lo_prim_prop->set_edm_type( iv_edm_type = 'String' ).      "#EC NOTEXT
 lo_prim_prop->set_max_length( iv_max_length = '1' ).       "#EC NOTEXT

 lo_prim_prop = lo_complex_type->create_prim_property( iv_property_name = 'PARVA' ). "#EC NOTEXT
 lo_prim_prop->set_add_annotations( abap_true ).

 lo_prim_prop->set_edm_name( 'Parva' ).                     "#EC NOTEXT
 lo_prim_prop->set_edm_type( iv_edm_type = 'String' ).      "#EC NOTEXT
 lo_prim_prop->set_max_length( iv_max_length = '1' ).       "#EC NOTEXT

 lo_prim_prop = lo_complex_type->create_prim_property( iv_property_name = 'PARTXT' ). "#EC NOTEXT
 lo_prim_prop->set_add_annotations( abap_true ).

 lo_prim_prop->set_edm_name( 'Partxt' ).                    "#EC NOTEXT
 lo_prim_prop->set_edm_type( iv_edm_type = 'String' ).      "#EC NOTEXT
 lo_prim_prop->set_max_length( iv_max_length = '1' ).       "#EC NOTEXT
***********************************************************************************************************************************
...
***********************************************************************************************************************************
 lo_complex_type = io_model->create_complex_type_by_struct( iv_complex_type_name = 'REFUSERX' is_structure = ls_REFUSERX
                                                            iv_add_conv_to_prim_props = abap_true ). "#EC NOTEXT

 lo_complex_type->set_edm_name( 'RefUserx' ).               "#EC NOTEXT
...
***********************************************************************************************************************************
 ...
 lo_prim_prop->set_edm_name( 'RefUser' ).                   "#EC NOTEXT
 lo_prim_prop->set_edm_type( iv_edm_type = 'String' ).      "#EC NOTEXT
 lo_prim_prop->set_max_length( iv_max_length = '1' ).       "#EC NOTEXT
  endmethod.
...
*   ENTITY - UserChange
***********************************************************************************************************************************
 lo_entity_type = io_model->create_entity_type( iv_entity_type_name = 'USERCHANGE' ). "#EC NOTEXT

 lo_entity_type->set_edm_name( 'UserChange' ).              "#EC NOTEXT
...
*   Complex Properties
***********************************************************************************************************************************
 lo_complex_prop = lo_entity_type->create_complex_property( 'LOGONDATAX' ).
 lo_complex_prop->set_edm_name( 'Logondatax' ).             "#EC NOTEXT
 lo_complex_prop->set_complex_type( 'LOGONDATAX' ).

 lo_complex_prop = lo_entity_type->create_complex_property( 'PARAMETERX' ).
 lo_complex_prop->set_edm_name( 'Parameterx' ).             "#EC NOTEXT
 lo_complex_prop->set_complex_type( 'PARAMETERX' ).
 ...
 lo_complex_prop = lo_entity_type->create_complex_property( 'REF_USERX' ).
 lo_complex_prop->set_edm_name( 'RefUserx' ).               "#EC NOTEXT
 lo_complex_prop->set_complex_type( 'REFUSERX' ).

 lo_complex_prop = lo_entity_type->create_complex_property( 'GROUPSX' ).
 lo_complex_prop->set_edm_name( 'Groupsx' ).                "#EC NOTEXT
 lo_complex_prop->set_complex_type( 'GROUPSX' ).
 ...
 lo_complex_prop = lo_entity_type->create_complex_property( 'ADDRESSX' ).
 lo_complex_prop->set_edm_name( 'Addressx' ).               "#EC NOTEXT
 lo_complex_prop->set_complex_type( 'ADDRESSX' ).

 lo_complex_prop = lo_entity_type->create_complex_property( 'DEFAULTSX' ).
 lo_complex_prop->set_edm_name( 'Defaultsx' ).              "#EC NOTEXT
 lo_complex_prop->set_complex_type( 'DEFAULTSX' ).
 ...
 lo_complex_prop = lo_entity_type->create_complex_property( 'COMPANYX' ).
 lo_complex_prop->set_edm_name( 'Companyx' ).               "#EC NOTEXT
 lo_complex_prop->set_complex_type( 'COMPANYX' ).
...
***********************************************************************************************************************************
 ...
 lo_entity_set->set_edm_name( 'UserChangeSet' ).            "#EC NOTEXT
  endmethod.
ENDCLASS.
