class /SAVY/CL_USER_ROLE_ASS_MPC definition
  public
...
TT_USERASSIGN type standard table of TS_USERASSIGN .
  ...
  types:
     TS_ACTIVITYGROUPS type BAPIAGR .
  types:
...
TT_STATUSRESULT type standard table of TS_STATUSRESULT .
  ...
  constants GC_ACTIVITYGROUPS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Activitygroups' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value '/SAVY/CL_USER_ROLE_ASS_MPC====CP' ##NO_TEXT.
...
CLASS /SAVY/CL_USER_ROLE_ASS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'SAVY.USER_ROLE_ASSIGN_SRV' ).

define_userassign( ).
define_activitygroups( ).
define_statusresult( ).
define_associations( ).
  endmethod.
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Activitygroups' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FromDat' iv_abap_fieldname = 'FROM_DAT' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ToDat' iv_abap_fieldname = 'TO_DAT' ). "#EC NOTEXT
lo_property->set_type_edm_datetime( ).
lo_property->set_precison( iv_precision = 7 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPIAGR'
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'UserassignToActivitygroups' "#EC NOTEXT
                            iv_left_type        = 'Userassign' "#EC NOTEXT
                            iv_right_type       = 'Activitygroups' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - UserassignToActivitygroups
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Username'   iv_dependent_property = 'AgrName' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'UserassignToActivitygroupsSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'UserassignSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ActivitygroupsSet'             "#EC NOTEXT
                                              iv_association_name      = 'UserassignToActivitygroups' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ActivitygroupsSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'ACTIVITYGROUPSSET' "#EC NOTEXT
                                                              iv_association_name = 'UserassignToActivitygroups' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_ROLE_ASS_MPC=>TS_STATUSRESULT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_ROLE_ASS_MPC=>TS_USERASSIGN' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251104090139'.                  "#EC NOTEXT
