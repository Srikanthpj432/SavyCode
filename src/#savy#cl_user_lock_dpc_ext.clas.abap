class /SAVY/CL_USER_LOCK_DPC_EXT definition
  public
  inheriting from /SAVY/CL_USER_LOCK_DPC
  create public .
...
CLASS /SAVY/CL_USER_LOCK_DPC_EXT IMPLEMENTATION.
  ...
  METHOD /iwbep/if_mgw_appl_srv_runtime~execute_action.
    ...
    IF iv_Action_name =  TEXT-001.         "'UserLock'.
