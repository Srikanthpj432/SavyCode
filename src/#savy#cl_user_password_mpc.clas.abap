class /SAVY/CL_USER_PASSWORD_MPC definition
  public
...
TT_USERNEWPASSWORD type standard table of TS_USERNEWPASSWORD .
  ...
  constants GC_USERNEWPASSWORD type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'UserNewpassword' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value '/SAVY/CL_USER_PASSWORD_MPC====CP' ##NO_TEXT.
...
CLASS /SAVY/CL_USER_PASSWORD_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'SAVY.USER_PASSWORD_RESET_SRV' ).

define_statusresult( ).
define_usernewpassword( ).
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_PASSWORD_MPC=>TS_STATUSRESULT' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'UserNewpassword' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'NewPassword' iv_abap_fieldname = 'NEWPASSWORD' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_PASSWORD_MPC=>TS_USERNEWPASSWORD' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251120160731'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Username'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'UserNewpassword'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '004'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'NewPassword'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'UserNewpassword'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
