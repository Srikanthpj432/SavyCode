class /SAVY/CL_USER_PROFI_01_DPC_EXT definition
  public
  inheriting from /SAVY/CL_USER_PROFI_01_DPC
  create public .
...
CLASS /SAVY/CL_USER_PROFI_01_DPC_EXT IMPLEMENTATION.
  ...
  METHOD /iwbep/if_mgw_appl_srv_runtime~create_deep_entity.
    ...
    TRY.
        ...
        LOOP AT lt_profiles ASSIGNING FIELD-SYMBOL(<fs_profiles>).
          ...
          ENDTRY.
          CONCATENATE <fs_profiles>-bapiprof ls_deep-status INTO ls_deep-status SEPARATED BY space.
