class /SAVY/CL_V4_USER_DELET_MPC_EXT definition
  public
  inheriting from /SAVY/CL_V4_USER_DELET_MPC
  create public .
...
CLASS /SAVY/CL_V4_USER_DELET_MPC_EXT IMPLEMENTATION.
  ...
  method /IWBEP/IF_V4_MP_BASIC~DEFINE.
    ...
    lo_action = io_model->create_action( iv_action_name = 'USERDELETE' ).
    lo_action->set_edm_name( 'USERDELETE' ).
*
...
*    " ← Get entity type from model first!
    ...
    lo_actimp = lo_action->create_action_import( iv_action_import_name = 'USERDELETE' ).
