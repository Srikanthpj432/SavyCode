class /SAVY/CL_V4_USER_LOCK_MPC_EXT definition
  public
  inheriting from /SAVY/CL_V4_USER_LOCK_MPC
  create public .
...
CLASS /SAVY/CL_V4_USER_LOCK_MPC_EXT IMPLEMENTATION.
  ...
  METHOD /iwbep/if_v4_mp_basic~define.
    ...
    lo_action = io_model->create_action( iv_action_name = 'USERLOCK' ).
    lo_action->set_edm_name( 'USERLOCK' ).
*
...
*    " ← Get entity type from model first!
    ...
    lo_actimp = lo_action->create_action_import( iv_action_import_name = 'USERLOCK' ).
