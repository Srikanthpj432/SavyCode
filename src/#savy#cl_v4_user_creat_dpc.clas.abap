class /SAVY/CL_V4_USER_CREAT_DPC definition
  public
...
protected section.
  ...
  methods STATUSRESULTSET_UPDATE
    ...
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCREATESET_CREATE
    importing
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_CREATE
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_CREATE
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCREATESET_DELETE
    importing
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_DELETE
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_DELETE
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCREATESET_READ
    importing
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_READ
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_READ
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCREATESET_READ_LIST
    importing
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_LIST
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_LIST
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCREATESET_UPDATE
    importing
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_UPDATE
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_UPDATE
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCREATE_READ_REF_KEY_LIST
    importing
...
CLASS /SAVY/CL_V4_USER_CREAT_DPC IMPLEMENTATION.
...
*&*   generated methods inside DPC subclass - /SAVY/CL_V4_USER_CREAT_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC subclass - /SAVY/CL_V4_USER_CREAT_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside DPC provider subclass - /SAVY/CL_V4_USER_CREAT_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*  DATA ls_groups  TYPE /savy/cl_v4_user_creat_mpc=>ts_groups.
...
*Used for setting business data
*  DATA lt_groups TYPE /savy/cl_v4_user_creat_mpc=>tt_groups.
...
*Used for setting business data
*  DATA ls_parameter  TYPE /savy/cl_v4_user_creat_mpc=>ts_parameter.
...
*Used for setting business data
*  DATA lt_parameter TYPE /savy/cl_v4_user_creat_mpc=>tt_parameter.
...
*Used for setting business data
*  DATA ls_statusresult  TYPE /savy/cl_v4_user_creat_mpc=>ts_statusresult.
...
*Used for setting business data
*  DATA lt_statusresult TYPE /savy/cl_v4_user_creat_mpc=>tt_statusresult.
...
*Used for setting business data
*  DATA ls_usercreate  TYPE /savy/cl_v4_user_creat_mpc=>ts_usercreate.
...
* Report list of request options handled by application
  ...
  method USERCREATESET_READ_LIST.
*&----------------------------------------------------------------------------------------------*
*&* This class has been generated on 24.03.2026 17:09:54 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
...
*Used for setting business data
*  DATA lt_usercreate TYPE /savy/cl_v4_user_creat_mpc=>tt_usercreate.
...
* Report list of request options handled by application
  ...
  method USERCREATE_READ_REF_KEY_LIST.
*&----------------------------------------------------------------------------------------------*
*&* This class has been generated on 24.03.2026 17:09:54 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
