class /SAVY/CL_V4_USER_LOCK_DPC definition
  public
...
CLASS /SAVY/CL_V4_USER_LOCK_DPC IMPLEMENTATION.
...
*&*   generated methods inside DPC subclass - /SAVY/CL_V4_USER_LOCK_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC subclass - /SAVY/CL_V4_USER_LOCK_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*  DATA ls_statusresult  TYPE /savy/cl_v4_user_lock_mpc=>ts_statusresult.
...
*Used for setting business data
*  DATA lt_statusresult TYPE /savy/cl_v4_user_lock_mpc=>tt_statusresult.
