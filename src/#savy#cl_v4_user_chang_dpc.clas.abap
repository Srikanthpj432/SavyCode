class /SAVY/CL_V4_USER_CHANG_DPC definition
  public
...
protected section.
  ...
  methods STATUSRESULTSET_UPDATE
    ...
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCHANGESET_CREATE
    importing
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_CREATE
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_CREATE
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCHANGESET_DELETE
    importing
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_DELETE
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_DELETE
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCHANGESET_READ
    importing
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_READ
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_READ
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCHANGESET_READ_LIST
    importing
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_LIST
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_LIST
    raising
      /IWBEP/CX_GATEWAY .
  methods USERCHANGESET_UPDATE
    importing
      !IO_RESPONSE type ref to /IWBEP/IF_V4_RESP_BASIC_UPDATE
      !IO_REQUEST type ref to /IWBEP/IF_V4_REQU_BASIC_UPDATE
    raising
...
CLASS /SAVY/CL_V4_USER_CHANG_DPC IMPLEMENTATION.
...
*&*   generated methods inside DPC subclass - /SAVY/CL_V4_USER_CHANG_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC subclass - /SAVY/CL_V4_USER_CHANG_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*  DATA ls_groups  TYPE /savy/cl_v4_user_chang_mpc=>ts_groups.
...
*Used for setting business data
*  DATA lt_groups TYPE /savy/cl_v4_user_chang_mpc=>tt_groups.
...
*Used for setting business data
*  DATA ls_parameter  TYPE /savy/cl_v4_user_chang_mpc=>ts_parameter.
...
*Used for setting business data
*  DATA lt_parameter TYPE /savy/cl_v4_user_chang_mpc=>tt_parameter.
...
*Used for setting business data
*  DATA ls_statusresult  TYPE /savy/cl_v4_user_chang_mpc=>ts_statusresult.
...
*Used for setting business data
*  DATA lt_statusresult TYPE /savy/cl_v4_user_chang_mpc=>tt_statusresult.
...
*Used for setting business data
*  DATA ls_userchange  TYPE /savy/cl_v4_user_chang_mpc=>ts_userchange.
...
*Used for setting business data
*  DATA lt_userchange TYPE /savy/cl_v4_user_chang_mpc=>tt_userchange.
