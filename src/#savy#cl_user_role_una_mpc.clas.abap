class /SAVY/CL_USER_ROLE_UNA_MPC definition
  public
...
TT_STATUSRESULT type standard table of TS_STATUSRESULT .
  ...
  constants GC_USERROLES type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Userroles' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value '/SAVY/CL_USER_ROLE_UNA_MPC====CP' ##NO_TEXT.
...
CLASS /SAVY/CL_USER_ROLE_UNA_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'SAVY.USER_ROLE_UNASSIGN_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'UserunassignToActivitygroups' "#EC NOTEXT
                            iv_left_type        = 'Userunassign' "#EC NOTEXT
                            iv_right_type       = 'Userroles' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - UserunassignToActivitygroups
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Username'   iv_dependent_property = 'AgrName' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'UserunassignToActivitygroupsSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'UserunassignSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'UserrolesSet'             "#EC NOTEXT
                                              iv_association_name      = 'UserunassignToActivitygroups' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'UserrolesSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'USERROLESSET' "#EC NOTEXT
                                                              iv_association_name = 'UserunassignToActivitygroups' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_ROLE_UNA_MPC=>TS_STATUSRESULT' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Userroles' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_ROLE_UNA_MPC=>TS_USERROLES' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_ROLE_UNA_MPC=>TS_USERUNASSIGN' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251120151512'.                  "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Userroles'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
