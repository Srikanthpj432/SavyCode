class /SAVY/CL_USER_DELETE_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_USERDELETE,
        USERNAME type C length 12,
    end of TS_USERDELETE .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value '/SAVY/CL_USER_DELETE_MPC======CP' ##NO_TEXT.
...
CLASS /SAVY/CL_USER_DELETE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'SAVY.USER_DELETE_SRV' ).
...
lo_action = model->create_action( 'UserDelete' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'Statusresult' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = '/SAVY/CL_USER_DELETE_MPC=>TS_USERDELETE' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_DELETE_MPC=>TS_STATUSRESULT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251212145310'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'UserDelete'.                                      "#EC NOTEXT
