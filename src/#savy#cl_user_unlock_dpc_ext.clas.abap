class /SAVY/CL_USER_UNLOCK_DPC_EXT definition
  public
  inheriting from /SAVY/CL_USER_UNLOCK_DPC
  create public .
...
CLASS /SAVY/CL_USER_UNLOCK_DPC_EXT IMPLEMENTATION.
  ...
  METHOD /iwbep/if_mgw_appl_srv_runtime~execute_action.
    ...
    DATA ls_result      TYPE /savy/cl_user_unlock_mpc=>ts_statusresult.
    ...
    IF iv_Action_name = TEXT-001.      "'UserUnlock'.
