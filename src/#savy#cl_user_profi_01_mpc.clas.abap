class /SAVY/CL_USER_PROFI_01_MPC definition
  public
...
TT_STATUSRESULT type standard table of TS_STATUSRESULT .
  ...
  constants GC_USERASSIGN type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Userassign' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value '/SAVY/CL_USER_PROFI_01_MPC====CP' ##NO_TEXT.
...
CLASS /SAVY/CL_USER_PROFI_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'SAVY.USER_PROFILE_ASSIGN_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'UserassignToUserprofiles' "#EC NOTEXT
                            iv_left_type        = 'Userassign' "#EC NOTEXT
                            iv_right_type       = 'Userprofiles' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - UserassignToUserprofiles
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Username'   iv_dependent_property = 'Bapiprof' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'UserassignToUserprofilesSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'UserassignSet'              "#EC NOTEXT
...
* Navigation Properties for entity - Userassign
lo_entity_type = model->get_entity_type( iv_entity_name = 'Userassign' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_PROFI_01_MPC=>TS_STATUSRESULT' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Userassign' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_PROFI_01_MPC=>TS_USERASSIGN' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_PROFI_01_MPC=>TS_USERPROFILES' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260119122249'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Userassign'.                            "#EC NOTEXT
