class /SAVY/CL_USER_UNLOCK_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value '/SAVY/CL_USER_UNLOCK_MPC======CP' ##NO_TEXT.
...
CLASS /SAVY/CL_USER_UNLOCK_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'SAVY.USER_UNLOCK_SRV' ).
...
lo_action = model->create_action( 'UserUnlock' ).  "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = '/SAVY/CL_USER_UNLOCK_MPC=>TS_USERUNLOCK' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_UNLOCK_MPC=>TS_STATUSRESULT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251103114640'.                  "#EC NOTEXT
