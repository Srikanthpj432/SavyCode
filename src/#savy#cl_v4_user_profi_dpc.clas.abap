class /SAVY/CL_V4_USER_PROFI_DPC definition
  public
...
CLASS /SAVY/CL_V4_USER_PROFI_DPC IMPLEMENTATION.
...
*&*   generated methods inside DPC subclass - /SAVY/CL_V4_USER_PROFI_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC subclass - /SAVY/CL_V4_USER_PROFI_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside DPC provider subclass - /SAVY/CL_V4_USER_PROFI_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*  DATA ls_statusresult  TYPE /savy/cl_v4_user_profi_mpc=>ts_statusresult.
...
*Used for setting business data
*  DATA lt_statusresult TYPE /savy/cl_v4_user_profi_mpc=>tt_statusresult.
...
*Used for setting business data
*  DATA ls_userassign  TYPE /savy/cl_v4_user_profi_mpc=>ts_userassign.
...
*Used for setting business data
*  DATA lt_userassign TYPE /savy/cl_v4_user_profi_mpc=>tt_userassign.
...
*Used for setting business data
*  DATA ls_userprofiles  TYPE /savy/cl_v4_user_profi_mpc=>ts_userprofiles.
...
*Used for setting business data
*  DATA lt_userprofiles TYPE /savy/cl_v4_user_profi_mpc=>tt_userprofiles.
