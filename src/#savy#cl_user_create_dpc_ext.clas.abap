class /SAVY/CL_USER_CREATE_DPC_EXT definition
  public
  inheriting from /SAVY/CL_USER_CREATE_DPC
  create public .
...
CLASS /SAVY/CL_USER_CREATE_DPC_EXT IMPLEMENTATION.


  METHOD /iwbep/if_mgw_appl_srv_runtime~create_deep_entity.
**********************************************************************
* Method: User Creation
* Purpose: User Creation through an api Service Using bapi
...
**********************************************************************
    ...
    DATA: BEGIN OF ltt_deep_struc,
            statusresultset TYPE TABLE OF /savy/cl_user_create_mpc=>ts_statusresult.
            INCLUDE TYPE /savy/cl_user_create_mpc=>ts_usercreate.
    DATA:   parameterset    TYPE TABLE OF /savy/cl_user_create_mpc=>ts_parameter,
            groupsset       TYPE TABLE OF /savy/cl_user_create_mpc=>ts_groups,
    ...
    DATA: ls_deep        LIKE ltt_deep_struc,
          ...
          ls_result      TYPE /savy/cl_user_create_mpc=>ts_statusresult,
    ...
    ls_defaults = ls_deep-defaults.    " FIXED: Was ls_deep-address
