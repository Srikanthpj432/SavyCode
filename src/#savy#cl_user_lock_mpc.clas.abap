class /SAVY/CL_USER_LOCK_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value '/SAVY/CL_USER_LOCK_MPC========CP' ##NO_TEXT.
...
CLASS /SAVY/CL_USER_LOCK_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'SAVY.USER_LOCK_SRV' ).
...
lo_action = model->create_action( 'UserLock' ).  "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = '/SAVY/CL_USER_LOCK_MPC=>TS_USERLOCK' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = '/SAVY/CL_USER_LOCK_MPC=>TS_STATUSRESULT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251103100939'.                  "#EC NOTEXT
